        ...
        <div className="relative" ref={profileRef}>
          <button onClick={() => setProfileOpen((o) => !o)} className="flex items-center gap-2 rounded-lg p-1 pr-2 hover:bg-ink-100">
            ...
            <span className="hidden text-left sm:block">
              <span className="block text-sm font-semibold leading-tight text-ink-800">{user.name}</span>
          ...
          {profileOpen && (
            <div className="absolute right-0 top-12 z-30 w-60 rounded-xl border border-ink-200 bg-white p-1.5 shadow-soft animate-slide-up">
              ...
              <button onClick={() => { logout(); navigate('/login'); }} className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-red-600 hover:bg-red-50">
